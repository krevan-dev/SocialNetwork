<template>
  <div class="text-white py-4">
    <div class="clip-text d-flex justify-content-between align-items-center" v-if="account.id">
      <img
        :src="account.picture"
        alt=""
        class="rounded selectable ms-3"
        height="45"
      ...
      <button
        class="btn selectable text-danger lighten-30"
        @click="logout"
        title="Logout"
      >
